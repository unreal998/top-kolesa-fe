...
export const checkoutSlice = createSlice({
  ...
  reducers: {
    ...
    fetchCityListByInputSuccess(state, { payload }: PayloadAction<CityListResponce>) {
    ...
    fetchWarehouseListByInputSuccess(state, { payload }: PayloadAction<WarehouseListResponce>) {
